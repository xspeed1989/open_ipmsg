...
const zh = {
  ...
  'dialog.ok': '确定',
  'dialog.dismiss': '关闭提示',
  // ---- 后端错误（码 → 文案；{e} 会填进后端给的细节） ----
  'err.fallback': '操作失败',
  'err.withDetail': '操作失败：{e}',
  'err.E_UNLOCK_NOT_FOUND': '找不到该消息',
  'err.E_UNLOCK_DISABLED': '本机未启用密码验证，无法解锁密码消息',
  'err.E_UNLOCK_BAD_PASSWORD': '密码错误',
  'err.E_RECALL_NOT_FOUND': '找不到该消息',
  'err.E_RECALL_NOT_MINE': '只能撤回自己发出的消息',
  'err.E_RECALL_HAS_FILES': '附件消息不支持撤回（对方可能已开始下载）',
  'err.E_SEND_EMPTY': '不能发送空消息',
  'err.E_NICKNAME_REQUIRED': '昵称不能为空',
  'err.E_IMAGE_UNSUPPORTED': '不支持的图片类型',
  'err.E_IMAGE_TOO_BIG': '图片过大，不做内联预览',
  'err.E_READ_FAILED': '读取失败：{e}',
  'err.E_FILE_MISSING': '图片文件不存在（可能已被移动或删除）',
  'err.E_SAVE_FAILED': '保存失败：{e}',
  'err.E_CLIPBOARD_FAILED': '读取剪贴板失败：{e}',
  'err.E_CLIPBOARD_TIMEOUT': '读取剪贴板超时：{e}',
  'err.E_VIEWER_OPEN_FAILED': '打开图片窗口失败：{e}',
  'err.E_IMPORT_FAILED': '导入任务失败：{e}',
  'err.E_IMPORT_OPEN_FAILED': '无法打开：{e}',
  'err.E_IMPORT_NOT_IPMSG': '{e} 不是官方 IP Messenger 的日志库（找不到 msg_tbl 表）',
  'err.E_IMPORT_READ_FAILED': '读取消息失败：{e}',
  'err.E_PERSIST_FAILED': '聊天记录保存失败：{e}',
  // 表情包导入预检
  'err.E_PACK_BAD_PATH': '包内路径不合法',
  'err.E_PACK_FILE_MISSING': '包内缺少该文件',
  'err.E_PACK_BAD_FORMAT': '不是支持的图片格式',
  'err.E_PACK_TOO_BIG': '超过 {e}MB 上限',
  'err.E_PACK_TOTAL_TOO_BIG': '包内图片总大小超限',
  'err.E_PACK_DUPLICATE': '表情库里已有相同图片',
  // 截图（后端 ShotErr 的码）
  'err.CAPTURE_FAILED': '抓屏失败：{e}',
  'err.CAPTURE_BUSY': '正在截屏，请稍候',
  'err.PORTAL_MISSING': '系统未提供截图服务（xdg-desktop-portal）：{e}',
  'err.PORTAL_DENIED': '截图请求被系统拒绝（响应码 {e}）',
  'err.PORTAL_TIMEOUT': '截图超时：系统未在 15 秒内响应',
  'err.DECODE_FAILED': '截图数据解码失败：{e}',
  'err.MAC_PERMISSION': '需要「屏幕录制」权限：系统设置 → 隐私与安全性 → 屏幕录制，勾选本应用后重启应用生效',
  // ---- 设置弹窗 ----
  'settings.title': '设置',
  ...
  'settings.autoOpenSecret': '自动打开封书',
  'settings.autoOpenSecretHint': '收到的封书直接显示正文，不用再点「开封」；关闭后按信封占位显示，点开才能看。密码锁不受影响，仍需输入本机密码。',
  'settings.agentAddrPh': 'ip:2425（留空关闭）',
  ...
  'settings.shotHotkeyHint': '默认 Alt+A；点进输入框后直接按组合键即可修改，Esc 清空表示不注册；改完快捷键需重启应用才生效',
  ...
  // ---- 自定义表情包 ----
  'emoji.tabUnicode': '表情',
  'emoji.stickerHint': '图片表情包（拖拽排序、右键移到最前/删除，顺序会保存）',
  'emoji.moveFront': '移到最前',
  'emoji.alreadyFirst': '已经是最前面了',
  'emoji.moved': '已移到最前',
  'emoji.tabCustom': '图片表情',
  'emoji.empty': '还没有图片表情',
  'emoji.emptyHint': '在本区域点右键可导入图片或表情包；也可以在聊天里右键别人发来的图，选「添加到表情」',
  'emoji.importImages': '导入图片',
  'emoji.importPack': '导入表情包',
  'emoji.exportPack': '导出表情包',
  'emoji.addToEmoji': '添加到表情',
  'emoji.addedToEmoji': '已添加到表情',
  'emoji.addNeedDownload': '该图片尚未下载，正在下载…',
  'emoji.srcUnavailable': '本地没有这张图的文件（历史导入的附件只有文件名，无法添加）',
  'emoji.rename': '重命名',
  'emoji.delete': '删除',
  'emoji.exportOne': '导出此表情',
  'emoji.renameTitle': '重命名表情',
  'emoji.deleteTitle': '删除表情',
  'emoji.deleteConfirm': '确定删除选中的 {n} 个表情？此操作不可撤销。',
  'emoji.imported': '已导入 {n} 个表情',
  'emoji.importSkipped': '已导入 {n} 个，跳过 {m} 个：{why}',
  'emoji.importFailed': '导入失败：{e}',
  'emoji.loadFailed': '读取表情库失败：{e}',
  'emoji.sendFailed': '发送表情失败：{e}',
  'emoji.gone': '表情已不存在（可能已被删除）',
  'emoji.packTitle': '导入表情包',
  'emoji.packLoading': '正在读取表情包…',
  'emoji.packTotal': '共 {n} 张，可导入 {m} 张',
  'emoji.packSelectAll': '全选可导入项',
  'emoji.packDup': '已存在',
  'emoji.untitled': '表情',
  'emoji.packImport': '导入选中 {n} 张',
  'emoji.packDone': '已导入 {n} 张表情',
  'emoji.exportAll': '导出全部表情（{n} 张）',
  'emoji.exportSelected': '导出选中的 {n} 张',
  'emoji.exportTitle': '导出表情包',
  'emoji.exportDone': '已导出 {n} 张表情到 {path}',
  'emoji.exportEmpty': '还没有可导出的表情',
  'emoji.packDefaultName': '表情包',
  'emoji.tooMany': '一次最多导入 {n} 个文件',
  'emoji.filterName': '表情包',
  'chat.send': '发送',
  'chat.inputPh': '输入消息…',
...
const en = {
  ...
  // ---- In-app dialogs (replacing native alert/confirm/prompt) ----
  'dialog.ok': 'OK',
  'dialog.dismiss': 'Dismiss',
  // ---- Backend errors (code → text; {e} is the detail the backend attached) ----
  'err.fallback': 'Something went wrong',
  'err.withDetail': 'Something went wrong: {e}',
  'err.E_UNLOCK_NOT_FOUND': 'Message not found',
  'err.E_UNLOCK_DISABLED': 'Password verification is off on this device, so this message cannot be unsealed',
  'err.E_UNLOCK_BAD_PASSWORD': 'Wrong password',
  'err.E_RECALL_NOT_FOUND': 'Message not found',
  'err.E_RECALL_NOT_MINE': 'You can only recall your own messages',
  'err.E_RECALL_HAS_FILES': 'Messages with attachments cannot be recalled (the peer may have started downloading)',
  'err.E_SEND_EMPTY': 'Nothing to send',
  'err.E_NICKNAME_REQUIRED': 'Nickname is required',
  'err.E_IMAGE_UNSUPPORTED': 'Unsupported image type',
  'err.E_IMAGE_TOO_BIG': 'Image is too large for inline preview',
  'err.E_READ_FAILED': 'Read failed: {e}',
  'err.E_FILE_MISSING': 'Image file is missing (moved or deleted)',
  'err.E_SAVE_FAILED': 'Save failed: {e}',
  'err.E_CLIPBOARD_FAILED': 'Clipboard read failed: {e}',
  'err.E_CLIPBOARD_TIMEOUT': 'Clipboard read timed out: {e}',
  'err.E_VIEWER_OPEN_FAILED': 'Failed to open the image window: {e}',
  'err.E_IMPORT_FAILED': 'Import failed: {e}',
  'err.E_IMPORT_OPEN_FAILED': 'Cannot open: {e}',
  'err.E_IMPORT_NOT_IPMSG': '{e} is not an official IP Messenger log database (no msg_tbl table)',
  'err.E_IMPORT_READ_FAILED': 'Failed to read messages: {e}',
  'err.E_PERSIST_FAILED': 'Failed to save chat history: {e}',
  // Sticker pack pre-check
  'err.E_PACK_BAD_PATH': 'Invalid path inside the pack',
  'err.E_PACK_FILE_MISSING': 'File is missing from the pack',
  'err.E_PACK_BAD_FORMAT': 'Not a supported image format',
  'err.E_PACK_TOO_BIG': 'Over the {e} MB limit',
  'err.E_PACK_TOTAL_TOO_BIG': 'Total image size in the pack is over the limit',
  'err.E_PACK_DUPLICATE': 'The library already has this image',
  // Screenshot (codes from the backend ShotErr)
  'err.CAPTURE_FAILED': 'Screen capture failed: {e}',
  'err.CAPTURE_BUSY': 'A screen capture is already in progress',
  'err.PORTAL_MISSING': 'No screenshot service available (xdg-desktop-portal): {e}',
  'err.PORTAL_DENIED': 'The system denied the screenshot request (response code {e})',
  'err.PORTAL_TIMEOUT': 'Screenshot timed out: the system did not respond within 15 seconds',
  'err.DECODE_FAILED': 'Failed to decode the screenshot: {e}',
  'err.MAC_PERMISSION': 'Screen Recording permission is required: System Settings → Privacy & Security → Screen Recording, tick this app and restart it',
  // ---- 设置弹窗 ----
  ...
  'settings.encrypt': 'Encryption',
  'settings.encryptOn': 'On',
  'settings.encryptOff': 'Off',
  'settings.encryptHint': 'All chats use plaintext when this is off',
  // 协议扩展区（不在/密码/自动打开封书/代理/成员主/IPDict/IPv6 组播）：
  // 这些译文曾经误放在 zh 字典里又被紧随其后的中文覆盖，en 缺 key 时
  // t() 回退 zh，英文界面就一直显示中文 —— 英文文案必须定义在 en 这里
  'settings.extTitle': 'IPMsg protocol extensions',
  ...
  'settings.autoOpenSecret': 'Open sealed messages automatically',
  'settings.autoOpenSecretHint': 'Show incoming sealed messages right away instead of requiring a click to unseal. Turn it off to keep the envelope placeholder. Password-locked messages are unaffected and still need the local password.',
  'settings.agentAddrPh': 'ip:2425 (empty = off)',
  ...
  'settings.shotHotkeyHint': 'Default Alt+A. Click the field and press a combination; Esc clears it (no global shortcut). A changed shortcut takes effect only after restarting the app',
  ...
  'emoji.stickerHint': 'Image stickers (drag to sort; right-click to move to front/delete)',
  'emoji.moveFront': 'Move to front',
  'emoji.alreadyFirst': 'Already at the front',
  'emoji.moved': 'Moved to front',
  'emoji.tabCustom': 'Image stickers',
  'emoji.empty': 'No image stickers yet',
  'emoji.emptyHint': 'Right-click here to import images or a sticker pack, or right-click an image in a chat and pick “Add to stickers”',
  'emoji.importImages': 'Import images',
  'emoji.importPack': 'Import pack',
  'emoji.exportPack': 'Export pack',
  'emoji.addToEmoji': 'Add to stickers',
  'emoji.addedToEmoji': 'Added to stickers',
  'emoji.addNeedDownload': 'Image not downloaded yet, downloading…',
  'emoji.srcUnavailable': 'No local file for this image (attachments imported from history have a name only)',
  'emoji.rename': 'Rename',
  'emoji.delete': 'Delete',
  'emoji.exportOne': 'Export this sticker',
  'emoji.renameTitle': 'Rename sticker',
  'emoji.deleteTitle': 'Delete sticker',
  'emoji.deleteConfirm': 'Delete {n} selected sticker(s)? This cannot be undone.',
  'emoji.imported': 'Imported {n} sticker(s)',
  'emoji.importSkipped': 'Imported {n}, skipped {m}: {why}',
  'emoji.importFailed': 'Import failed: {e}',
  'emoji.loadFailed': 'Cannot load sticker library: {e}',
  'emoji.sendFailed': 'Cannot send sticker: {e}',
  'emoji.gone': 'Sticker no longer exists (it may have been deleted)',
  'emoji.packTitle': 'Import sticker pack',
  'emoji.packLoading': 'Reading sticker pack…',
  'emoji.packTotal': '{n} sticker(s), {m} importable',
  'emoji.packSelectAll': 'Select all importable',
  'emoji.packDup': 'Already added',
  'emoji.untitled': 'Sticker',
  'emoji.packImport': 'Import {n} selected',
  'emoji.packDone': 'Imported {n} sticker(s)',
  'emoji.exportAll': 'Export all ({n})',
  'emoji.exportSelected': 'Export {n} selected',
  'emoji.exportTitle': 'Export sticker pack',
  'emoji.exportDone': 'Exported {n} sticker(s) to {path}',
  'emoji.exportEmpty': 'No stickers to export yet',
  'emoji.packDefaultName': 'Sticker pack',
  'emoji.tooMany': 'At most {n} files at a time',
  'emoji.filterName': 'Sticker pack',
  'chat.send': 'Send',
