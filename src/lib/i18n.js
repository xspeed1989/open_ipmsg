...
const zh = {
  ...
  'chat.alertFillContent': '请先在输入框填写要发送的内容（文字或粘贴的图片/文件）',
...
const en = {
  ...
  'chat.recall': 'Recall',
  'chat.recalledSelf': 'You recalled a message',
  ...
  'chat.alertFillContent': 'Type the content to send first (text or pasted images/files)',
